...
function OuterLabelField(props) {
    ...
    return (
        <>
            ...
            <View style={[StyleConstants.Textinput2, { alignSelf: 'center', width: width ? width : screenWidth - 40, backgroundColor: currentTheme().backgroundbg, borderColor: currentTheme().cardColor2 }]}>
                {
                    mandatary &&
                    <View style={{ backgroundColor: currentTheme().secondaryColor, height: 50, width: 5, borderTopLeftRadius: 8, borderBottomLeftRadius: 8, marginLeft: -12 }} />
...
export default OuterLabelField;