    ...
    return (
        <View style={{ flex: 1, backgroundColor: currentTheme().bgColor }}>
            ...
            <View style={{ flex: 1, backgroundColor:currentTheme().themeColor }}>
                ...
                <View style={[{ paddingHorizontal: 20,borderTopEndRadius:30,borderTopStartRadius:30,height:'100%',backgroundColor:currentTheme().bgColor }]}>

                    <View style={{ backgroundColor: '#FFECD7', marginTop: 10, padding: 10, width: screenWidth - 40, flexDirection: 'row', justifyContent: 'space-between', borderRadius: 10 }}>
                        <Text style={{ color: currentTheme().textColor, fontSize: 15 }}>Open Time: {appSetting.max_withdraw}</Text>
                        <Text style={{ color: currentTheme().textColor, fontSize: 15 }}>Close Time: {appSetting.min_withdraw}</Text>
                    </View>

                    <View style={{ borderColor: currentTheme().inputBorderColor, borderWidth: 1, marginTop: 20, padding: 10, borderRadius: 10 }}>
                        <Text style={{ color: currentTheme().textColor, fontWeight: 'bold', fontSize: 15, }}>Add Withdraw Method</Text>
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: 10 }}>
                            <View style={styles.btnView}>
                                <Image source={icons.phonepe}
                    ...
                    <View style={{ marginTop: 20 }}>
                        ...
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: 20 }}>
                            <View style={[{ flexDirection: 'row', borderWidth: 0, borderWidth: 1, height: 45, width: screenWidth - 40, borderRadius: 10, paddingHorizontal: 20 }]}>
                    ...
                    <View style={{ backgroundColor: '#FFECD7', marginTop: 10, padding: 10, width: screenWidth - 40, justifyContent: 'space-between', borderRadius: 10 }}>
                        <Text style={{ color: 'red' }}>NOTE:-</Text>
                        <Text style={{ display: 'flex', overflow: 'hidden', width: screenWidth - 40 }}>Single Withdrawal Amount:-
                            The single withdrawal amount is between ₹ {appSetting.min_with} to ₹ {appSetting.max_with}.</Text>
                    </View>
